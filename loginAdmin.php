    ...
    <section class="elements-area mt-50 ">
        <div class="container">
            <div class="row">
                ...
                $loginAdmin = new users;
                $loginAdmin->loginAdmin($email, $password);
                    
                $error = $loginAdmin->loginAdmin($email,$password);
                $noUser = $loginAdmin->loginAdmin($email,$password);
                }
                ?>
                <!-- ##### Accordians ##### -->
                <div class="col-12 col-lg-6">
                    ...
                    ?>
                    <h6>Login <b class="text-danger">[Admin]</b> </h6>
                    ...
                    <div class="accordions mb-100" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                <input id="my-input" class="form-control" name="email" placeholder="Your Email" type="email">
                            </div>
                            ...
                            <div class="form-group hover hover-info">
                                <div class="row">
                                    <div class="col-md-6">
                                    <h6 class=""> <a href="register" class="text-danger">Forgotten Password</a></h6>
                                    </div>
                                </div>
                            </div>
